...
const AlertDialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content> & { overlayClassName?: string; highZIndex?: boolean }
>(({ className, overlayClassName, highZIndex, ...props }, ref) => {
  const zIndexClass = highZIndex ? "z-[100]" : "z-50"
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay className={cn(zIndexClass, overlayClassName)} />
